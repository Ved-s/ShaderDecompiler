...
public struct Opcode {
	public static readonly Dictionary<OpcodeType, OpcodeTypeInfo> OpcodeInfo = new() {
		...
		[OpcodeType.Neg] = new("neg"),
		[OpcodeType.Sin] = new("sin"),
		[OpcodeType.Cos] = new("cos"),
		[OpcodeType.Asin] = new("asin"),
		[OpcodeType.Acos] = new("acos"),
		[OpcodeType.Atan] = new("atan"),
		[OpcodeType.Lt] = new("lt"),
		[OpcodeType.Ge] = new("ge"),
		[OpcodeType.Atan2] = new("atan2"),
		[OpcodeType.Div] = new("div"),
		[OpcodeType.Movc] = new("movc"),
		[OpcodeType.Dot] = new("dot"),
		[OpcodeType.Noise] = new("noise"),
		[OpcodeType.MinScalar] = new("minscalar"),
		[OpcodeType.MaxScalar] = new("maxscalar"),
		[OpcodeType.LtScalar] = new("ltscalar"),
		[OpcodeType.GeScalar] = new("gescalar"),
		[OpcodeType.AddScalar] = new("addscalar"),
		[OpcodeType.MulScalar] = new("mulscalar"),
		[OpcodeType.Atan2Scalar] = new("atan2scalar"),
		[OpcodeType.DivScalar] = new("divscalar"),
		[OpcodeType.DotScalar] = new("dotscalar"),
		[OpcodeType.NoiseScalar] = new("noisescalar"),

		[OpcodeType.Unknown] = new("unknown"),
